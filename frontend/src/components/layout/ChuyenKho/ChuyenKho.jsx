                      ...
                      <div className="flex h-[750px] ">
                        ...
                        <div className=" border p-2 rounded-md w-1/4 h-full">
                          <div>
                            ...
                            <div className="mt-6  border rounded-lg " style={{
                              boxShadow:
                                "0 1px 2px 0 rgba(60,64,67,.1),0 2px 6px 2px rgba(60,64,67,.15)",
                            }}>
                                <ul className="flex p-2 bg-slate-100">
                                    <li className="w-3/4 font-semibold border-r border-gray-300">Tên hàng</li>
                                ...
                                <ul>
                                    <li className="flex p-1 border-b">
                                        <span className="w-3/4">Thuốc AAAAAAAAAAAAAAAA</span>
                            ...
                            <div>
                                <span className="font-semibold text-green-700 text-xl">100,000 VNĐ</span>
                            </div>
                            </div>
